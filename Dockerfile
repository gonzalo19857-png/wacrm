...
# Native Docker healthcheck so platforms that read it directly off the
# image (EasyPanel, Swarm, ...) get container health without relying on
# docker-compose.yml, which only the Compose CLI consults.
